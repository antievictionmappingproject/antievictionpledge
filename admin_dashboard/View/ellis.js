$(function () {
    if ($.session.get("myLoginKey") !== 'fdb5dfb15fdb85fd5bdf845b5fdb8fd5bfd84b5dfb854fbdf8b52dfb8df45b') {
        window.location.href = window.location.origin + "/admin_dashboard/";
    }
});
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++){
                    ...
                    content += '</label></td>';
                    content += '<td style="color: #fff;"> <button type="button" class="btn" style="background:#84606a" onclick=deletePledges(' + id + ')>Delete</button> ' +
